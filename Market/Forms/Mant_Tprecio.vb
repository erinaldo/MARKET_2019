Public Class Mant_Tprecio


    Dim OBJTPRECIOS As ClsTprecio
    ...
    Private Sub Mant_TPRECIO_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Mant_TPRECIO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call ToolSNuevo_Click(ToolNuevo, EventArgs.Empty)
        Call HabBotones(True)
        OBJTPRECIOS = New ClsTprecio
    End Sub
    ...
    Private Sub ToolGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolGrabar.Click
        ...
        If pb_agregar = True Then
            If BUSCAR_EXISTE("TIPO_PRECIO", "COD_TPRECIO", Me.TXT_COD.Text.Trim) = True Then
                MsgBox("Tipo de precio ya existe", MsgBoxStyle.Information) : Exit Sub
            End If
        End If
        ''GRABANDO
        If pb_agregar Then TIPO = "N" Else TIPO = "M"
        intvalor = OBJTPRECIOS.MANT_TPRECIOS(Me.TXT_COD.Text.Trim, Me.TXT_DESC.Text.Trim, TIPO)
        If intvalor = 0 Then
            MsgBox("Tipo de precio grabado con exito", MsgBoxStyle.Information)
            Call ToolSNuevo_Click(ToolNuevo, EventArgs.Empty)
            Call HabBotones(True)
        Else
    ...
    Private Sub ToolAnular_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolAnular.Click
        ...
        intvalor = OBJTPRECIOS.MANT_TPRECIOS(Me.TXT_COD.Text.Trim, Me.TXT_DESC.Text.Trim, intANULAR)
        If intvalor = 0 Then
            MsgBox("Tipo de precio anulado con exito", MsgBoxStyle.Information)
            Call ToolSNuevo_Click(ToolNuevo, EventArgs.Empty)
        Else
    ...
    Private Sub ToolSNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolNuevo.Click
        Try
            ...
            Me.LblAnulado.Text = ""
            Me.TXT_COD.Text = GENERAR_CODIGO("TIPO_PRECIO", "COD_TPRECIO", "00")
            Call HabBotones(False)
            Me.pb_agregar = True
            Me.pb_editar = False
            Me.TXT_COD.Enabled = False
