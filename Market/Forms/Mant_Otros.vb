Public Class Mant_Otros
    Dim OBJOTRO As ClsOtro
    ...
    Private Sub ToolAnular_Click(sender As Object, e As EventArgs) Handles ToolAnular.Click
        ...
        INTVALOR = OBJOTRO.Mantenimiento(intANULAR)
        If INTVALOR = 0 Then
            MsgBox("Otro anulado con exito", MsgBoxStyle.Information)
            Call ToolNuevo_Click(ToolNuevo, EventArgs.Empty)
        Else
    ...
    Private Sub ToolGrabar_Click(sender As Object, e As EventArgs) Handles ToolGrabar.Click
        ...
        If pb_agregar = True Then
            If BUSCAR_EXISTE("OTROS", "DESC_OTRO", Me.TXT_DESC.Text) = True Then
                MsgBox("Otro ya existe", MsgBoxStyle.Information) : Exit Sub
            End If
        End If
        ''GRABANDO
        With OBJOTRO
        ...
        INTVALOR = OBJOTRO.Mantenimiento(TIPO)
        If INTVALOR = 0 Then
            MsgBox("Otro grabado con exito", MsgBoxStyle.Information)
            Call ToolNuevo_Click(ToolNuevo, EventArgs.Empty)
            Call HabBotones(True)
        Else
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        With BusquedaMaestra
            ...
            If .GrecibeColumnaID <> "" Then
                OBJOTRO.Codigo = .GrecibeColumnaID
