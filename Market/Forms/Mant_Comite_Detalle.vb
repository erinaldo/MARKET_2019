Public Class Mant_Comite_Detalle
    ...
    Private Sub ToolAnular_Click(sender As Object, e As EventArgs) Handles ToolAnular.Click
        ...
        INTVALOR = OBJCOMITE.Mantenimiento(intANULAR)
        If INTVALOR = 0 Then
            MsgBox("Comite eliminado con exito", MsgBoxStyle.Information)
            Call ToolNuevo_Click(ToolNuevo, EventArgs.Empty)
        Else
    ...
    Sub ASIGNAR_DATOS()
        With OBJCOMITE
            ...
            Me.TXT_RUBRO.Tag = .Rubro
            Me.TXT_RUBRO.Text = .Rubro_Desc
            Me.CHK_ACTIVO.Checked = .Estado
            Me.CHK_INCLUIR.Checked = .Incluye
            Me.TXT_ESTIMADO.Text = .Estimado
        End With
    End Sub
    ...
    Private Sub ToolGrabar_Click(sender As Object, e As EventArgs) Handles ToolGrabar.Click
        ...
        If Me.TXT_RUBRO.Text = "" Then MsgBox("Ingrese el Rubro", MsgBoxStyle.Information) : Exit Sub
        ''VALIDAR SI EXISTE
        If pb_agregar = True Then
            If BUSCAR_EXISTE("DETALLE_COMITE", "DESC_DCOMITE", Me.TXT_DESC.Text) = True Then
                MsgBox("Comite ya existe", MsgBoxStyle.Information) : Exit Sub
            End If
        End If
        ''GRABANDO
        With OBJCOMITE
            ...
            .Rubro = Me.TXT_RUBRO.Tag
            .Estado = Me.CHK_ACTIVO.Checked
            .Incluye = Me.CHK_INCLUIR.Checked
            .Estimado = Val(Me.TXT_ESTIMADO.Text)
        End With
        If pb_agregar Then TIPO = "N" Else TIPO = "M"
        INTVALOR = OBJCOMITE.Mantenimiento(TIPO)
        If INTVALOR = 0 Then
            MsgBox("Comite grabado con exito", MsgBoxStyle.Information)
            Call ToolNuevo_Click(ToolNuevo, EventArgs.Empty)
            Call HabBotones(True)
        Else
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        With BusquedaMaestra
            ...
            If .GrecibeColumnaID <> "" Then
                OBJCOMITE.Codigo = .GrecibeColumnaID
                OBJCOMITE.BUSCAR()
                ASIGNAR_DATOS()
            End If
            .Close()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        With BusquedaMaestra
            ...
            ''
            If .GrecibeColumnaID <> "" Then
                Me.TXT_RUBRO.Tag = .GrecibeColumnaID
                TXT_RUBRO.Text = .GrecibeColumnaOpcional
            End If
            .Close()
        End With
    End Sub
