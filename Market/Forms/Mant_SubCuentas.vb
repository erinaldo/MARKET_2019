Public Class Mant_SubCuentas
    Dim OBJPLANCTA As ClsPlanCta
    ...
    Private Sub ToolGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolGrabar.Click
        ...
        If Me.TXT_SUBCTA.Text = "" Then MsgBox("Ingrese Codigo", MsgBoxStyle.Information) : Exit Sub

        ''VALIDAR SI EXISTE
        If pb_agregar = True Then
            'If BUSCAR_EXISTE("PLAN_CUENTASD", "DESC_PLANCTAD", Me.TXT_DESC.Text.Trim) = True Then
            '    MsgBox("SubCuenta ya existe", MsgBoxStyle.Information) : Exit Sub
            'End If
            If BUSCAR_EXISTE("PLAN_CUENTASD", "COD_PLANCTA+SUB_PLANCTA", Me.TXT_COD.Text + Me.TXT_SUBCTA.Text.Trim) = True Then
                MsgBox("Codigo ya existe", MsgBoxStyle.Information) : Exit Sub
            End If
        End If
        ''GRABANDO
        If pb_agregar Then TIPO = "N" Else TIPO = "M"
        intvalor = OBJPLANCTA.MANT_PLANCTAS_D(Me.TXT_COD.Text.Trim, Me.TXT_SUBCTA.Text, Me.TXT_DESC.Text.Trim, TIPO)
        If intvalor = 0 Then
            MsgBox("SubCuenta grabada con exito", MsgBoxStyle.Information)
            Call ToolSNuevo_Click(ToolNuevo, EventArgs.Empty)
            Call HabBotones(True)
        Else
    ...
    Private Sub ToolAnular_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolAnular.Click
        ...
        intvalor = OBJPLANCTA.MANT_PLANCTAS_D(Me.TXT_COD.Text.Trim, Me.TXT_SUBCTA.Text, Me.TXT_DESC.Text.Trim, intANULAR)
        If intvalor = 0 Then
            MsgBox("SubCuenta anulada con exito", MsgBoxStyle.Information)
            Call ToolSNuevo_Click(ToolNuevo, EventArgs.Empty)
        Else
    ...
    Private Sub picturebox1_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles picturebox1.Click
        ...
        With BusquedaMaestra
            ...
            If .GrecibeColumnaID <> "" Then
                ...
                Me.TXT_SUBCTA.Text = OBJPLANCTA.CORR_SUBCTA(.GrecibeColumnaID)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        With BusquedaMaestra
            ...
            ''
            If .GrecibeColumnaID <> "" Then
                Me.TXT_SUBCTA.Text = .GrecibeColumnaID
                Me.TXT_DESC.Text = .GrecibeColumnaOpcional
                Me.LblAnulado.Text = .GrecibeColumnaOpcional2
                'Me.TXT_Clave.Text = .GrecibeColumnaOpcional3
            End If
