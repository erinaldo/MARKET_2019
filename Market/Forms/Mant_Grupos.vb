Public Class Mant_Grupos
    ...
    Private Sub Mant_Grupos_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Mant_GRUPOS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ToolGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolGrabar.Click
        ...
        If Me.TXT_COD.Text = "" Then MsgBox("Ingrese Grupo", MsgBoxStyle.Information) : Exit Sub

        ''VALIDAR SI EXISTE
        If pb_agregar = True Then
            If BUSCAR_EXISTE("GRUPO", "COD_GRUPO", Me.TXT_COD.Text.Trim) = True Then
                MsgBox("Grupo ya existe", MsgBoxStyle.Information) : Exit Sub
            End If
        End If
        ''GRABANDO
        If pb_agregar Then TIPO = "N" Else TIPO = "M"
        intvalor = OBJGRUPO.MANT_GRUPOS(Me.TXT_COD.Text.Trim, Me.TXT_DESC.Text.Trim, TIPO)
        If intvalor = 0 Then
            MsgBox("Grupo grabado con exito", MsgBoxStyle.Information)
            Call ToolSNuevo_Click(ToolNuevo, EventArgs.Empty)
            Call HabBotones(True)
        Else
    ...
    Private Sub ToolAnular_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolAnular.Click
        ...
        intvalor = OBJGRUPO.MANT_GRUPOS(Me.TXT_COD.Text.Trim, Me.TXT_DESC.Text.Trim, intANULAR)
        If intvalor = 0 Then
            MsgBox("Grupo anulado con exito", MsgBoxStyle.Information)
            Call ToolSNuevo_Click(ToolNuevo, EventArgs.Empty)
        Else
