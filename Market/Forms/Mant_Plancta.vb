Public Class Mant_Plancta
    ...
    Private Sub ToolGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolGrabar.Click
        ...
        If pb_agregar = True Then
            If BUSCAR_EXISTE("PLAN_CUENTAS", "DESC_PLANCTA", Me.TXT_DESC.Text.Trim) = True Then
                MsgBox("Plan de Cuenta ya existe", MsgBoxStyle.Information) : Exit Sub
            End If
            If BUSCAR_EXISTE("PLAN_CUENTAS", "COD_PLANCTA", Me.TXT_COD.Text.Trim) = True Then
                MsgBox("Codigo ya existe", MsgBoxStyle.Information) : Exit Sub
            End If
        End If
        ''GRABANDO
        If pb_agregar Then TIPO = "N" Else TIPO = "M"
        intvalor = OBJPLANCTA.MANT_PLANCTAS(Me.TXT_COD.Text.Trim, Me.TXT_DESC.Text.Trim, TIPO)
        If intvalor = 0 Then
            MsgBox("Cuenta grabada con exito", MsgBoxStyle.Information)
            Call ToolSNuevo_Click(ToolNuevo, EventArgs.Empty)
            Call HabBotones(True)
        Else
    ...
    Private Sub ToolAnular_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolAnular.Click
        ...
        intvalor = OBJPLANCTA.MANT_PLANCTAS(Me.TXT_COD.Text.Trim, Me.TXT_DESC.Text.Trim, intANULAR)
        If intvalor = 0 Then
            MsgBox("Cuenta anulada con exito", MsgBoxStyle.Information)
            Call ToolSNuevo_Click(ToolNuevo, EventArgs.Empty)
        Else
