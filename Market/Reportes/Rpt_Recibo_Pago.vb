...
Public Class Rpt_Recibo_Pago
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Market.Rpt_Recibo_Pago.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_COD_PAGO() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_Recibo_Pago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Recibo_Pago = New Rpt_Recibo_Pago()
        rpt.Site = Me.Site
        Return rpt
    End Function
