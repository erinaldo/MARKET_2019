...
Public Class Rpt_Recibo_Cobranza
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_Recibo_Cobranza.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Market.Rpt_Recibo_Cobranza.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_COD_COBRO() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_Recibo_Cobranza
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Recibo_Cobranza = New Rpt_Recibo_Cobranza()
        rpt.Site = Me.Site
        Return rpt
    End Function
