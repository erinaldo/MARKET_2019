...
Public Class Rpt_Rep_Stock
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Market.Rpt_Rep_Stock.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_COMBO_CANT() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CANT() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_Rep_Stock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Rep_Stock = New Rpt_Rep_Stock()
        rpt.Site = Me.Site
        Return rpt
    End Function
