...
Public Class Rpt_Cobradores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Market.Rpt_Cobradores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Cobradores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Cobradores = New Rpt_Cobradores()
        rpt.Site = Me.Site
        Return rpt
    End Function
