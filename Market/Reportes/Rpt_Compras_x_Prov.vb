...
Public Class Rpt_Compras_x_Prov
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Market.Rpt_Compras_x_Prov.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CADENA() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_Compras_x_Prov
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Compras_x_Prov = New Rpt_Compras_x_Prov()
        rpt.Site = Me.Site
        Return rpt
    End Function
