...
Public Class Rpt_Tipo_Pagos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Market.Rpt_Tipo_Pagos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Tipo_Pagos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Tipo_Pagos = New Rpt_Tipo_Pagos()
        rpt.Site = Me.Site
        Return rpt
    End Function
