...
Public Class Rpt_Kardex_Val
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Market.Rpt_Kardex_Val.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PC() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_Kardex_Val
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Kardex_Val = New Rpt_Kardex_Val()
        rpt.Site = Me.Site
        Return rpt
    End Function
